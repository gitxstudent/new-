...
function vnexpress_net($url){
		...
		foreach($html->find('img') as $e) $e->src = "http://vnexpress.net".$e->src;
		...
		$xata['data'] = $html->find('p[class=Lead]', 0)->innertext .'<br> '. $html->find('div[cpms_content=true]', 0)->innertext;
		return $xata;
	}